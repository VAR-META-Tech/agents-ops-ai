...
export const TEAM_MEMBERS = [
  {
    ...
    image: <Image className='object-cover' width={128} height={128} src={dungPham.src} alt='Dung Pham' />,
  },
  {
    id: 2,
    name: 'Tory Nguyen',
    ...
    image: <Image className='object-cover' width={128} height={128} src={toryNguyen.src} alt='Tory Nguyen' />,
  },
  {
    id: 3,
    name: 'Luan Dang',
    ...
    image: <Image className='object-cover' width={128} height={128} src={luanDang.src} alt='Luan Dang' />,
  },
];
