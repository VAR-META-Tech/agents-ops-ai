      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={header}>
            ...
            <Text style={headerSubtitle}>You received a new inquiry from your AgentOps website</Text>
          </Section>
          ...
          <Section style={contentSection}>
            ...
            {email && (
              <Section style={actionSection}>
                <Link
                  href={`mailto:${email}?subject=Re: Contact Form Submission from ${fullName || 'Contact'}`}
                  style={button}
                >
          ...
          <Section style={footer}>
            <Text style={footerText}>This email was sent from your AgentOps contact form.</Text>
            {fullName && <Text style={footerText}>Reply directly to this email to respond to {fullName}.</Text>}
          </Section>
        </Container>
      </Body>
    </Html>
