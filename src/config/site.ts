...
export const siteConfig = {
  ...
  description: 'Transform your business with custom AI agents. Expert consulting, development, and integration services for Sales, HR, Customer Service, Content, and Finance automation. Automate 60-70% of employee tasks.',
